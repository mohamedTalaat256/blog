...
@section('content')
    ...
    <div class="container" style="margin-top: 80px; margin-bottom: 80px; padding-top: 80px">
        ...
        <div class="card card-custom">
                ...
                <form class="form" action="{{ route('user_store_request') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="card-body">


                        <h3 class="font-size-lg text-dark font-weight-bold mb-6">Request:</h3>
                        <div class="mb-3">
